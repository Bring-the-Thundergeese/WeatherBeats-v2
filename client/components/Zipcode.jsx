  ...
  return (
    <div className="mainInputContainer">
          <div className='buttonContainer'>
            <input className="mainInputBox" type="text" placeholder="ZIPCODE" onChange={(e) => setLocation(e.target.value)} />
            <button type="submit" className="submitButton" onClick={() => fetchWeatherData(location)}>Location</button>
          </div>
